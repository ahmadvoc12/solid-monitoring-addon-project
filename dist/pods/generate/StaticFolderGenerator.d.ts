 ...
 */
export declare class StaticFolderGenerator implements ResourcesGenerator {
    private readonly resourcesGenerator;
    private readonly templateFolder;
    constructor(resourcesGenerator: TemplatedResourcesGenerator, templateFolder: string);

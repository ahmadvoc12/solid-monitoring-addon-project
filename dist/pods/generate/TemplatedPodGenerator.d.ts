...
export declare class TemplatedPodGenerator implements PodGenerator {
     ...
     */
    constructor(storeFactory: ComponentsJsFactory, variableHandler: VariableHandler, configStorage: KeyValueStorage<string, unknown>, baseUrl: string, configTemplatePath?: string);

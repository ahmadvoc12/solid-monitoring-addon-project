 ...
 */
export declare class ConvertingPatcher extends RepresentationPatcher<Representation> {
     ...
     */
    constructor(patcher: RepresentationPatcher<Representation>, converter: RepresentationConverter, intermediateType?: string, defaultType?: string);
    canHandle(input: RepresentationPatcherInput<Representation>): Promise<void>;
    handle(input: RepresentationPatcherInput<Representation>): Promise<Representation>;
}

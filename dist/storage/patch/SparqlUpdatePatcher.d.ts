 ...
 */
export declare class SparqlUpdatePatcher extends RepresentationPatcher<RdfDatasetRepresentation> {
    ...
    handle({ identifier, patch, representation }: RepresentationPatcherInput<RdfDatasetRepresentation>): Promise<RdfDatasetRepresentation>;

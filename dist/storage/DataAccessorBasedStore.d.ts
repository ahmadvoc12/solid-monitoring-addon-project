...
export declare class DataAccessorBasedStore implements ResourceStore {
    ...
    constructor(accessor: DataAccessor, identifierStrategy: IdentifierStrategy, auxiliaryStrategy: AuxiliaryStrategy, metadataStrategy: AuxiliaryStrategy);
    ...
    modifyResource(identifier: ResourceIdentifier, patch: Patch, conditions?: Conditions): Promise<never>;
     ...
     */
    protected writeMetadata(identifier: ResourceIdentifier, representation: Representation): Promise<ChangeMap>;
    /**
     ...
     * @returns Identifiers of resources that were possibly modified.
     */
    protected writeData(identifier: ResourceIdentifier, representation: Representation, isContainer: boolean, createContainers: boolean, exists: boolean): Promise<ChangeMap>;
    /**
     ...
     */
    protected createRecursiveContainers(container: ResourceIdentifier): Promise<ChangeMap>;
    /**

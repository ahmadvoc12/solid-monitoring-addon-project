...
export declare class FileDataAccessor implements DataAccessor {
     ...
     */
    protected getStats(path: string): Promise<Stats>;
    /**
     ...
     */
    protected writeMetadataFile(link: ResourceLink, metadata: RepresentationMetadata): Promise<boolean>;
    /**
     ...
     */
    protected verifyExistingExtension(link: ResourceLink): Promise<void>;
    /**
     ...
     */
    protected writeDataFile(path: string, data: Readable): Promise<void>;
}

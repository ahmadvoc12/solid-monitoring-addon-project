...
import { ContentType } from '../../util/Header';
 ...
 */
export declare function isRepresentationMetadata(object: unknown): object is RepresentationMetadata;
/**
...
export declare class RepresentationMetadata {
     ...
     */
    constructor(identifier?: MetadataIdentifier, contentType?: string | ContentType);
    /**
     * @param metadata - Starts as a copy of the input metadata.
     * @param contentType - Override for the content type of the representation.
     */
    constructor(metadata?: RepresentationMetadata, contentType?: string | ContentType);
    /**
     * @param contentType - The content type of the representation.
     */
    constructor(contentType?: string | ContentType);
    /**
     ...
     */
    quads(subject?: NamedNode | BlankNode | string | null, predicate?: NamedNode | null, object?: NamedNode | BlankNode | Literal | string | null, graph?: MetadataGraph | null): Quad[];
    /**
     ...
     */
    addQuad(subject: NamedNode | BlankNode | string, predicate: NamedNode, object: NamedNode | BlankNode | Literal | string, graph?: MetadataGraph): this;
    /**
     ...
     */
    removeQuad(subject: NamedNode | BlankNode | string, predicate: NamedNode, object: NamedNode | BlankNode | Literal | string, graph?: MetadataGraph): this;
    /**
     ...
     */
    add(predicate: NamedNode, object: MetadataValue, graph?: MetadataGraph): this;
    /**
     ...
     */
    remove(predicate: NamedNode, object: MetadataValue, graph?: MetadataGraph): this;
    /**
     ...
     */
    removeAll(predicate: NamedNode, graph?: MetadataGraph): this;
    /**
     * Verifies if a specific triple can be found in the metadata.
     * Undefined parameters are interpreted as wildcards.
     */
    has(predicate?: NamedNode | string | null, object?: NamedNode | BlankNode | Literal | string | null, graph?: MetadataGraph | null): boolean;
    /**
     ...
     */
    getAll(predicate: NamedNode, graph?: MetadataGraph): Term[];
    /**
     ...
     */
    get(predicate: NamedNode, graph?: MetadataGraph): Term | undefined;
    /**
     ...
     */
    set(predicate: NamedNode, object?: MetadataValue, graph?: MetadataGraph): this;
     ...
     */
    get contentTypeObject(): ContentType | undefined;
    set contentTypeObject(contentType: ContentType | undefined);
    /**
     * Shorthand for the CONTENT_LENGTH predicate.
     */
    get contentLength(): number | undefined;
    set contentLength(input: number | undefined);
}

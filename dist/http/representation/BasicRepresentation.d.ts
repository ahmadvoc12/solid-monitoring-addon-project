...
export declare class BasicRepresentation implements Representation {
     ...
     */
    constructor(data: Guarded<Readable> | Readable | unknown[] | string, metadata: RepresentationMetadata | MetadataRecord, binary?: boolean);
    /**
     * @param data - The representation data
     * @param metadata - The representation metadata
     ...
     * @param binary - Whether the representation is a binary or object stream
     */
    constructor(data: Guarded<Readable> | Readable | unknown[] | string, metadata: RepresentationMetadata | MetadataRecord, contentType?: string, binary?: boolean);
    /**
     * @param data - The representation data
     * @param contentType - The representation's content type
     * @param binary - Whether the representation is a binary or object stream
     */
    constructor(data: Guarded<Readable> | Readable | unknown[] | string, contentType: string, binary?: boolean);
    /**
     * @param data - The representation data
     ...
     * @param binary - Whether the representation is a binary or object stream
     */
    constructor(data: Guarded<Readable> | Readable | unknown[] | string, identifier: MetadataIdentifier, metadata?: MetadataRecord, binary?: boolean);
    /**
     * @param data - The representation data
     * @param identifier - The representation's identifier
     * @param contentType - The representation's content type
     * @param binary - Whether the representation is a binary or object stream
     */
    constructor(data: Guarded<Readable> | Readable | unknown[] | string, identifier: MetadataIdentifier, contentType?: string, binary?: boolean);
    /**

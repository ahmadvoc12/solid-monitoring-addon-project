 ...
 */
export declare class StreamingHttpListeningActivityHandler extends StaticHandler {
    private readonly streamMap;
    private readonly source;
    protected readonly logger: import("../../../index").Logger;
    constructor(emitter: ActivityEmitter, streamMap: StreamingHttpMap, source: NotificationHandler);
    private emit;
}

 ...
 */
export declare function generateWebSocketUrl(id: string): string;
/**
 ...
 */
export declare function parseWebSocketRequest(baseUrl: string, request: IncomingMessage): string;

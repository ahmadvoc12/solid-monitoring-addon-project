 ...
 */
export declare class WebSocket2023Emitter extends NotificationEmitter {
    protected readonly logger: import("../../../index").Logger;
    private readonly socketMap;
    constructor(socketMap: SetMultiMap<string, WebSocket>);
    handle({ channel, representation }: NotificationEmitterInput): Promise<void>;
}

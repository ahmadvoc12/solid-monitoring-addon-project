...
export declare function isWebSocket2023Channel(channel: NotificationChannel): channel is WebSocketChannel2023;
/**
 ...
 */
export declare class WebSocketChannel2023Type extends BaseChannelType {
    protected readonly logger: import("../../../index").Logger;
    constructor(route: InteractionRoute, features?: string[]);
    initChannel(data: Store, credentials: Credentials): Promise<WebSocketChannel2023>;
}

 ...
 */
export declare class BaseServerFactory implements HttpServerFactory {
    protected readonly logger: import("../index").Logger;
    private readonly configurator;
    private readonly options;
    constructor(configurator: ServerConfigurator, options?: BaseServerFactoryOptions);
    /**

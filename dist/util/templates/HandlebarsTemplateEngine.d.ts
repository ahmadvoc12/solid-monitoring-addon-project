 ...
 */
export declare class HandlebarsTemplateEngine<T extends Dict<unknown> = Dict<unknown>> extends ExtensionBasedTemplateEngine<T> {
    private readonly baseUrl;
    /**
     * @param baseUrl - Base URL of the server.
     * @param supportedExtensions - The extensions that are supported by this template engine (defaults to 'hbs').
     */
    constructor(baseUrl: string, supportedExtensions?: string[]);
    handle({ contents, template }: TemplateEngineInput<T>): Promise<string>;
}

 ...
 */
export declare abstract class ExtensionBasedTemplateEngine<T extends Dict<unknown> = Dict<unknown>> extends TemplateEngine<T> {
    ...
    canHandle({ template }: TemplateEngineInput<T>): Promise<void>;
}

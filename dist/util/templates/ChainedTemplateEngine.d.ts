 ...
 */
export declare class ChainedTemplateEngine<T extends Dict<unknown> = Dict<unknown>> extends TemplateEngine<T> {
    ...
    canHandle(input: TemplateEngineInput<T>): Promise<void>;

 ...
 */
export declare function setSafeInterval<TArgs>(logger: Logger, message: string, callback: (...cbArgs: TArgs[]) => Promise<void> | void, ms?: number, ...args: TArgs[]): NodeJS.Timeout;

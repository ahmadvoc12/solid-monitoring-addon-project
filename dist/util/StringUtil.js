...
exports.msToDuration = exports.isUrl = exports.isValidFileName = exports.sanitizeUrlPart = exports.splitCommaSeparated = void 0;
/**
 ...
 */
function sanitizeUrlPart(urlPart) {
    return urlPart.replaceAll(/\W/gu, '-');
}
exports.sanitizeUrlPart = sanitizeUrlPart;
/**

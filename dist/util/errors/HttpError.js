...
class HttpError extends Error {
    ...
    constructor(statusCode, name, message, options = {}) {
        ...
        this.metadata = options.metadata ?? new RepresentationMetadata_1.RepresentationMetadata();
        this.generateMetadata();
    }
    static isInstance(error) {
        return (0, ErrorUtil_1.isError)(error) &&
     ...
     */
    generateMetadata() {
        this.metadata.add(Vocabularies_1.SOLID_ERROR.terms.errorResponse, generateHttpErrorUri(this.statusCode));
        this.metadata.add(Vocabularies_1.HTTP.terms.statusCodeNumber, (0, TermUtil_1.toLiteral)(this.statusCode, Vocabularies_1.XSD.terms.integer));
    }
}
...
function generateHttpErrorClass(statusCode, name) {
    return class SpecificHttpError extends HttpError {
        static statusCode = statusCode;
        static uri = generateHttpErrorUri(statusCode);

 ...
 */
export declare class OAuthHttpError extends HttpError {
    readonly mandatoryFields: OAuthErrorFields;
    constructor(mandatoryFields: OAuthErrorFields, name?: string, statusCode?: number, message?: string, options?: HttpErrorOptions);
    static isInstance(error: unknown): error is OAuthHttpError;
}

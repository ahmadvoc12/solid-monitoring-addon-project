 ...
 */
export interface GenericEventEmitter<TEvent extends string | symbol, TFunc extends (...args: any[]) => void> extends EventEmitter {
 ...
 */
export declare function createGenericEventEmitterClass<T extends EventEmitter>(): new () => T;

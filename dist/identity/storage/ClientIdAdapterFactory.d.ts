 ...
 */
export declare class ClientIdAdapter extends PassthroughAdapter {
     ...
     */
    private parseRdfClientId;
}
export declare class ClientIdAdapterFactory extends PassthroughAdapterFactory {
    private readonly converter;

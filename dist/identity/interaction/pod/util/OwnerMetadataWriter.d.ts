 ...
 */
export declare class OwnerMetadataWriter extends MetadataWriter {
    protected logger: import("../../../../index").Logger;
    protected podStore: PodStore;
    protected storageStrategy: StorageLocationStrategy;
    constructor(podStore: PodStore, storageStrategy: StorageLocationStrategy);
    handle({ metadata, response }: MetadataWriterInput): Promise<void>;
}

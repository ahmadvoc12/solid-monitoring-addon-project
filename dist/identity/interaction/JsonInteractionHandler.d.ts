 ...
 */
export declare abstract class JsonInteractionHandler<TOut extends Dict<Json> = Dict<Json>> extends AsyncHandler<JsonInteractionHandlerInput, JsonRepresentation<TOut>> {
}

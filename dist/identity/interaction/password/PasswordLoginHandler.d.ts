 ...
 */
export declare class PasswordLoginHandler extends ResolveLoginHandler implements JsonView {
    protected readonly logger: import("../../../index").Logger;
    private readonly passwordStore;
    constructor(args: PasswordLoginHandlerArgs);
    getView(): Promise<JsonRepresentation>;
    login({ json }: JsonInteractionHandlerInput): Promise<JsonRepresentation<LoginOutputType>>;
}

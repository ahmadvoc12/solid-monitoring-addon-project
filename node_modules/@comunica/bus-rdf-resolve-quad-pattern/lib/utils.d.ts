 ...
 */
export declare function isDataSourceRawType(dataSource: IDataSource | IDataSourceRawContext): dataSource is string | RDF.Source;
/**
 ...
 */
export declare function getDataSourceContext(dataSource: IDataSource | IDataSourceRawContext, context: IActionContext): IActionContext;
/**

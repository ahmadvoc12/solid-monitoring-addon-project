...
class RdfSourceSparql {
     ...
     */
    async queryBindings(endpoint, query) {
    ...
    match(subject, predicate, object, graph) {
        ...
        new Promise(async (resolve, reject) => {
            try {
                ...
                const bindingsStream = await this.queryBindings(this.url, countQuery);
            ...
            .catch(() => quads.setProperty('metadata', { cardinality: { type: 'estimate', value: Number.POSITIVE_INFINITY }, canContainUndefs: false }));

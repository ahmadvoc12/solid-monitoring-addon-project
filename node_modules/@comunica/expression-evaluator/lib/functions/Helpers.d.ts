...
import type { Quad, ISerializable } from '../expressions';
...
export declare class Builder {
    ...
    onBinaryTyped<L extends ISerializable, R extends ISerializable>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (left: L, right: R) => Term, addInvalidHandling?: boolean): Builder;
    onTernaryTyped<A1 extends ISerializable, A2 extends ISerializable, A3 extends ISerializable>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (a1: A1, a2: A2, a3: A3) => Term, addInvalidHandling?: boolean): Builder;
    ...
    onQuaternaryTyped<A1 extends ISerializable, A2 extends ISerializable, A3 extends ISerializable, A4 extends ISerializable>(types: ArgumentType[], op: (context: ICompleteSharedContext) => (a1: A1, a2: A2, a3: A3, a4: A4) => Term, addInvalidHandling?: boolean): Builder;

...
exports.matchAgent = void 0;
const acp_1 = require("../constant/acp");
/**
 ...
 */
function matchAgent(matcher, context) {
    // If at least one agent IRI matches return true
    if (matcher.agent.some((matchingAgent) => {
        // The ACP Public Agent matches every context
        if (matchingAgent === acp_1.ACP.PublicAgent) {
            return true;
        }
...
//# sourceMappingURL=match_agent.js.map
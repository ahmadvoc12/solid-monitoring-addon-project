...
export declare const ACCOUNT_TYPE = "account";
/**
 ...
 */
export type AccountLoginStorage<T extends Record<string, Record<string, ValueTypeDescription<keyof T | typeof ACCOUNT_TYPE>>>> = LoginStorage<T & {

import type { IndexObject, StringKey, TypeObject, ValueTypeDescription } from '../../../../storage/keyvalue/IndexedStorage';
 ...
 */
export declare const ACCOUNT_SETTINGS_REMEMBER_LOGIN = "rememberLogin";
 ...
 */
export type MinimalAccountSettings = {
...
export interface AccountStore<TSettings extends GenericAccountSettings = MinimalAccountSettings> {
     ...
     */
    getSetting: <TKey extends keyof TSettings>(id: string, setting: TKey) => Promise<TypeObject<TSettings>[TKey] | undefined>;
    /**
     ...
     */
    updateSetting: <TKey extends StringKey<TSettings>>(id: string, setting: TKey, value: TypeObject<TSettings>[TKey]) => Promise<void>;
}

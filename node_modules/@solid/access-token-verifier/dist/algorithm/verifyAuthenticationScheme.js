...
exports.verifyAuthenticationScheme = void 0;
const AuthenticationSchemeVerificationError_1 = require("../error/AuthenticationSchemeVerificationError");
/**
 ...
 */
function verifyAuthenticationScheme(authorizationHeader) {
    if (!/^(DPoP|Bearer) /i.test(authorizationHeader)) {
        throw new AuthenticationSchemeVerificationError_1.AuthenticationSchemeVerificationError(authorizationHeader);
    }
}
exports.verifyAuthenticationScheme = verifyAuthenticationScheme;
//# sourceMappingURL=verifyAuthenticationScheme.js.map
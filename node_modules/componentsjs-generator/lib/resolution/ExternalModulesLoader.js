...
class ExternalModulesLoader {
     ...
     */
    findExternalPackages(classIndex, constructors) {
    ...
    indexClassInExternalPackage(classReference, externalPackages) {
    ...
    indexParameterRangeInExternalPackage(parameterRange, externalPackages) {
     ...
     */
    async buildModuleStateSelective(req, packageNames) {
        const moduleStateBuilder = new componentsjs_1.ModuleStateBuilder(this.logger);
        ...
        let packageNamesNew = packageNames;
     ...
     */
    buildNodeModulePathsSelective(req, nodeModuleImportPaths, packageNames) {
        const packages = [];
     ...
     */
    async loadExternalComponents(req, externalPackages) {
        ...
        const objectLoader = componentsjs_1.ComponentsManagerBuilder.createObjectLoader();
        const componentRegistry = new componentsjs_1.ComponentRegistry({
            moduleState,
            objectLoader,
            logger: this.logger,
            componentResources,
        ...
        const componentFinalizer = new componentsjs_1.ComponentRegistryFinalizer({
            objectLoader,
            // We pass another logger, because there's no valuable information being logged here related to generation
            logger: componentsjs_1.ComponentsManagerBuilder.createLogger('error'),
            componentResources,
            componentRegistry,
        });
     ...
     */
    async dumpModuleState(moduleState, externalPackages) {
...
exports.ExternalModulesLoader = ExternalModulesLoader;
//# sourceMappingURL=ExternalModulesLoader.js.map